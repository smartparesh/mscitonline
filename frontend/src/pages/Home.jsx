...
import { Phone, MessageCircle, CheckCircle, GraduationCap, Users, Clock, Monitor, Award, BookOpen, Laptop } from 'lucide-react';
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center">
              ...
              <div className="relative group inline-block">
                ...
                <img src="https://images.unsplash.com/photo-1756885375569-f04400d99cee" alt="Diverse Indian learners" className="relative rounded-2xl shadow-2xl max-w-2xl w-full h-[300px] object-cover" />
              </div>
            </div>
          </div>
        </div>
